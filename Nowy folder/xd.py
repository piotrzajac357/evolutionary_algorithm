...
def generate_random_input(dim: int = 1, costs_range: int = 1, what_seed: int = 1) -> List[List[int]]:
...
efg = generate_random_input(10, 100)
for p in efg:
    print(p)
...
print("losowo wygenerowany wektor 10 wspolczynnikow z zakresu 0.5 - 1.5 z krokiem 0.01")
wsp = generate_random_coefficients_vector(4, 0.5, 1.5, 0.01)
print(wsp)
